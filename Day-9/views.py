...
def task3(request):
	return render(request,'myApp/task3.html')
...
def offline(request):
	if request.method=="POST":
		...
		#print(name,email,mobile,gender,dob,lang,file)
		return render(request,'myApp/get.html',{'uname':name,'email':email,'mob':mobile,'gender':gender,'db':dob,'lan':lang,'fl':file})
